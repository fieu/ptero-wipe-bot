...
def delete_files(host: models.Host, server: models.Server, file_list: List[str]) -> bool:
    matched_files = []
...
def change_custom_map(host: models.Host, server: models.Server, custom_map: models.CustomMap):
    headers = {
        'Accept': 'application/json',
        'Content-Type': 'application/json',
        'Authorization': f'Bearer {host.api_token}',
